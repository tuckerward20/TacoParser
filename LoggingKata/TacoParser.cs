    ...
    public class TacoParser
    {
        ...
        public ITrackable Parse(string line)
        {
            ...
            if (cells.Length < 3)
            {
                ...
                logger.LogError("cell legth less than 3");
            ...
            var tacoBell = new TacoBell() { Name = place, Location = new Point { Latitude = latitude, Longitude = longitude } };
